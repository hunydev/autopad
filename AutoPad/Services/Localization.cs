...
public static class Loc
{
    ...
    public static string MsgStartupDisabledByPolicy => Get("Startup is controlled by your organization's policy and cannot be changed.", "시작 프로그램이 조직의 정책으로 제어되어 변경할 수 없습니다.");
